  ...
  return (
    <div class="h-62.5 text-sm w-125 m-6">
      <Chart data={data}>
        ...
        <Area dataKey="value2" stackId="myStack" class="fill-sc-200" />
        <Area dataKey="value1" stackId="myStack" class="fill-sc-400" />
        <Line dataKey="value1" stackId="myStack" stroke-width={2} />
        <Point dataKey="value1" stackId="myStack" r={5} />
        <Line dataKey="value2" stackId="myStack" stroke-width={2} />
        <Point dataKey="value2" stackId="myStack" r={5} />
